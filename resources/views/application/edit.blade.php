...
<div class="container mt-4">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{route('application.update',$applications->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea name="cover_letter" id="cover_letter" class="form-control" rows="5" required>{{ $applications->cover_letter }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="resume" class="form-label">Upload Resume (PDF only)</label>
                    {{-- accept=".pdf" --}}
                    <input type="file" name="resume" id="resume" value="{{$applications->resume}}" class="form-control" required>
                </div>
